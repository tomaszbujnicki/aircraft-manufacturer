export function clickFalse(element) {
...
export function clickTrue(element) {
...
export function createNewMessage(text, color) {
...
export function removeDOM_ELEMENT(element) {
  setTimeout(function () {
